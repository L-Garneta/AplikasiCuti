...
<div class="container-fluid">
	...
	<div class="card">
		<h5 class="card-header">
			...
			<button class="btn btn-primary btn-sm font-weight-bolder float-right" data-toggle="modal"
				data-target="#exampleModal"><i class="fas fa-plus"></i> Cuti Lain</button>
		</h5>
		<div class="card-body">
			<?php if ($sisa_cuti['is_approve'] == 0): ?>
				...
				<form action="<?php echo base_url('staf/add_cuti'); ?> " method="post">
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="kode_unik" value="<?php echo $kode_unik; ?>"
									readonly>
							</div>
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="nik" name="nik" class="form-control"
											value="<?php echo $user['nik']; ?>" readonly>
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="bagian" name="bagian" class="form-control"
											value="<?php echo $user['bagian']; ?>" readonly>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="jabatan" name="jabatan" class="form-control"
											value="<?php echo $user['jabatan']; ?>" readonly>
									</div>
								</div>
							</div>
							<div class="form-group">
						...
						<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<input type="varchar" id="alamat" name="alamat" class="form-control"
									value="<?php echo $user_cuti['alamat']; ?>">
					...
					<button type="submit" name="simpan" class="btn btn-primary"><i class="fas fa-save"></i> Simpan
						Data</button>
					<button type="button" class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg"><i
					...
					<form action="<?php echo base_url('staf/add_cuti_lain'); ?>" method="post">
						<div class="form-row">
							...
							<div class="form-group col-md-12">
								...
								<input type="text" class="form-control" name="kode_unik2"
									value="<?php echo $kode_unik2; ?>" readonly>
							</div>
							<div class="form-group col-md-3">
								<label for="tglInput">Tanggal Input</label>
								<input type="text" class="form-control" id="tglInput" name="tgl_input"
									value="<?php echo date('Y/m/d'); ?>" readonly>
							</div>
							<div class="form-group col-md-3">
						...
						<div class="form-row">
							<div class="form-group col-md-3">
								<label for="jabatan">Jabatan</label>
								<input type="text" class="form-control" id="tglInput" name="jabatan"
									value="<?php echo $user['jabatan']; ?>" readonly>
							</div>
							<div class="form-group col-md-3">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="alamat" name="alamat"
								value="<?php echo $user_cuti['alamat']; ?>" required>
						</div>
						<div class="form-row">
						...
						<button type="button" class="btn btn-info" data-toggle="modal"
							data-target=".bd-example-modal-lg"><i class="far fa-calendar-alt"></i>
							Kalender
						</button>
	...
	<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<center>
					<iframe
						src="https://calendar.google.com/calendar/embed?height=400&amp;wkst=1&amp;bgcolor=%23ffffff&amp;ctz=Asia%2FBangkok&amp;showTitle=0&amp;showPrint=0&amp;showTabs=0&amp;showCalendars=0&amp;showTz=0&amp;hl=id&amp;src=ZW4uaW5kb25lc2lhbiNob2xpZGF5QGdyb3VwLnYuY2FsZW5kYXIuZ29vZ2xlLmNvbQ&amp;color=%237986CB"
