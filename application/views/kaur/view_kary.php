...
<div class="container-fluid">
    ...
    <div class="card">
        <h5 class="card-header">
            <strong><?= $title; ?></strong>
            <a href="<?php echo base_url('kaur/list_kary'); ?>" class="btn btn-secondary btn-sm float-right">Kembali</a>
        </h5>
        <div class="card-body">
                ...
                <div class="col-md-6 pr-3">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                            <b>No Induk Kepegawaian</b> <a class="float-right"><?php echo $pegawai['nik']; ?></a>
                        </li>
                        <li class="list-group-item">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('kaur/view_kary/' . $pegawai['pegawai_id']); ?>" method="post">
                    <div class="row">
                        <div class="col-md-6">
